...
public class MenuPurchaser : MonoBehaviour, IStoreListener
{
    ...
    public MenuCashShopScript shop;
    ...
    public void InitializePurchasing()
    {
        ...
        // Adds the Cash Products
        builder.AddProduct(cash, ProductType.Consumable);
        builder.AddProduct(cashBundle, ProductType.Consumable);
        builder.AddProduct(cashSafe, ProductType.Consumable);
    ...
    // Buys the Cash using its general identifier
    public void BuyCash()
    {
        BuyProductID(cash);
    }

    // Buys the Cash Bundle using its general identifier
    public void BuyCashBundle()
    {
        BuyProductID(cashBundle);
    }

    // Buys the Cash Safe
    public void BuyCashSafe()
    {
        BuyProductID(cashSafe);
    }
    ...
    {
        // Cash has been purchased by the user
